...
definitions.rainfall.definition =
  'Seasonal total rainfall calculated between the defined start and defined end of the season';
definitions.length.definition = 'Calculated with the date range of Start of rains and End of the rains';
...
definitions.end.definition = 'Capacity of 100mm on 1st March reduces 0.5 with evaporation rate of 5mm per day';
