...
export const PICSA_MANUAL_RESOURCES: { [id in IPicsaManualId]: IResourceFile } = {
  ...
  picsa_manual_farmer_zm_loz: {
    ...
    type: 'file',
    subtype: 'pdf',
    title: 'Mukwa Wo Balimi Bafumana Zibo Ya Likalulo Za Mifukelo Wa Moya Ka Myaha Mwa Njimo Kapa Picsa Mwa Skuwa',
    mimetype: 'application/pdf',
    description: '',
    language: 'zm_loz',
  ...
  picsa_manual_farmer_zm_lue: {
    ...
    type: 'file',
    subtype: 'pdf',
    title: 'Kuzachila hamwe na Kufutula chajingonde na milimo Ya unjimi (PICSA)',
    mimetype: 'application/pdf',
    description: '',
    language: 'zm_lue',
  ...
  picsa_manual_farmer_zm_lun: {
    ...
    subtype: 'pdf',
    title:
      'Nyidimu Yakudinungá nakuzatila hamu nimuntu wezhima kukwata mbandi munyidimu yatalangá hakuhimpa champepela muwundimi (PICSA)',
    mimetype: 'application/pdf',
    description: '',
    language: 'zm_lun',
  ...
  picsa_manual_farmer_zm_toi: {
    ...
    subtype: 'pdf',
    title:
      'Kutola lubazu Kusangene a Milimo ya Bweende bwa luwo bwakainda, buliko a buli kumbele akaambo ka Bulimi (PICSA)',
    mimetype: 'application/pdf',
    description: '',
    language: 'zm_toi',
