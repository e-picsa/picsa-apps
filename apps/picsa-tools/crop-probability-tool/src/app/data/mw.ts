...
const MW_CROP_DATA: IStationCropInformation[] = [
  {
    ...
    station_name: 'CROP INFORMATION SHEET – KASUNGUDISTRICT, KASUNGU MET STATION',
        ...
        data: [
          {
            ...
            probabilities: ['10/10', '10/10', '8/10', '6/10'],
            water: ['252'],
          },
          {
            days: '110',
            variety: 'DK8033orSC403, SC 419, SC 423 (Kanyani)orPan4M-19, PAN6777',
            probabilities: ['10/10', '8/10', '5/10', '1/10'],
            water: ['308'],
          },
          {
            days: '120',
            ...
            probabilities: ['8/10', '6/10', '2/10', '0'],
            water: ['336'],
          },
          {
            days: '125',
          ...
          },
          {
            ...
            probabilities: ['5/10', '1/10', '0', '0'],
            water: ['392'],
          },
          {
            days: '150',
            variety: 'SC719, 725 Njovu',
            probabilities: ['2/10', '0', '0', '0'],
            water: ['420'],
          },
        ],
      },
        ...
        data: [
          {
            days: '105',
            variety: 'Kaphulira',
            probabilities: ['1', '8/10', '5/10', '1/10'],
            water: ['315'],
          },
          {
            days: '150',
      ...
      },
      {
        ...
        data: [
          ...
          },
          {
            days: '70',
            variety: 'Nua Beans',
            probabilities: ['10/10', '10/10', '10/10', '8/10'],
            water: ['196'],
          },
          {
            days: '95',
        ...
        data: [
          {
            days: '110',
            variety: 'Tikolore,',
            probabilities: ['9/10', '8/10', '5/10', '1/10'],
            water: ['341'],
          },
          {
            days: '120',
  ...
  },
  {
    ...
    station_name: 'Crop Information Sheet – NKHOTAKOTA MET STATION',
        ...
        data: [
          {
            days: '80',
            variety: 'SC304 (Kalulu)',
            probabilities: ['10/10', '10/10', '10/10', '10/10', '10/10'],
            water: ['264'],
          },
          {
            days: '90',
            variety: 'DK8033orSC403, SC 419, SC 423 (Kanyani)orPan4M-19, PAN6777',
            probabilities: ['10/10', '10/10', '10/10', '10/10', '8/10'],
            water: ['297'],
          },
          {
            days: '115',
            variety: 'SC537 (Mbidzi), DK 8031',
            probabilities: ['10/10', '9/10', '8/10', '5/10', '0'],
            water: ['380'],
          },
          {
            days: '120',
            variety: 'DK9089, MH39A, MH40A, MH42A, MH43A, SC513, DKC8033, PAN7M-89,MH18, ZM 523',
            probabilities: ['10/10', '8/10', '6/10', '1/10', '0'],
            water: ['396'],
          },
          {
            days: '128',
            variety: 'SC600 (Nkango)',
            probabilities: ['8/10', '5/10', '0', '0', '0'],
            water: ['422'],
          },
          {
            days: '158',
