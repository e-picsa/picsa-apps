...
@Component({
  ...
  templateUrl: './new-translations.component.html',
  styleUrls: ['./new-translations.component.scss'],
})
export class NewTranslationsComponent {
  en:string;
  mw_ny:string;
  sw:string;
  tg:string;
  ...
  submitForm() {
   ...
   this.service.addTranslation(data)
   .then((data) => {
