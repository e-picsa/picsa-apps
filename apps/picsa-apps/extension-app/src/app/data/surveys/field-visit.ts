        ...
        elements: [
          {
            type: 'comment',
            name: 'activities',
            title: 'Describe what training activities you conducted with the farmers today',
            rows: 3,
          ...
          },
          {
            ...
            title: 'Please give any comments or observations about how the farmers reacted to the training?',
            rows: 3,
            placeHolder:
          ...
          },
          {
            ...
            title: 'Do you think that the use of the tablet and the app helped the training session in any way? ',
            rows: 3,
          ...
          },
          {
            ...
            rows: 3,
            placeHolder: 'If so, please can you explain what these negative effects were.',
          },
          {
            type: 'comment',
            name: 'infoShared',
