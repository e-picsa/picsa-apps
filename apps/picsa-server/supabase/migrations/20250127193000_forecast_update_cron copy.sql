...
select cron.schedule('forecasts_db', '30 * * * *', $$ select public.call_edge_function('dashboard/climate-forecast-db','{}'::jsonb); $$);

select cron.schedule('forecasts_storage', '35 * * * *', $$ select public.call_edge_function('dashboard/climate-forecast-storage','{}'::jsonb); $$);
